...
namespace AksesuarSat_V1.Models
{
    ...
    public partial class OyunTicaretDBEntities : DbContext
    {
        public OyunTicaretDBEntities()
            : base("name=OyunTicaretDBEntities")
        {
        }
        ...
        public virtual ObjectResult<sp_UyeAdresSayisi_Result> sp_UyeAdresSayisi()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_UyeAdresSayisi_Result>("sp_UyeAdresSayisi");
        }
